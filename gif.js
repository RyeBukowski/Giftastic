        ...
        $.ajax({
            ...
            .done(function(response) {
                ...
                for (var i = 0; i < results.length; i++) {
                    ...
                    anIm.attr('src', results[i].images.fixed_height.url);

                    anIm.attr('data-still', results[i].images.fixed_height_still.url)

                    anIm.attr('data-animate', results[i].images.fixed_height.url)

                    .attr('data-state', 'still');

                    animalDiv.append(p);

                    animalDiv.append(anIm);
        ...
        $('#theButton').on('click', function(){
            ...
            var results = response.data;
                ...
                for (var i = 0; i < results.length; i++) {
                    ...
                    anIm.attr('src', results[i].images.fixed_height_still.url);
